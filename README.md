...
A full-featured e-commerce platform for Dansunauto's Closet — a Kenyan fashion brand offering everyday luxury clothing. Built with [Phoenix LiveView](https://hexdocs.pm/phoenix_live_view) and [Ecto](https://hexdocs.pm/ecto).
...
| `SITE_URL`    | `https://dansunautoscloset.com`     | Absolute base URL for emails & links |
...
| Email                   | Password      | Role        |
|-------------------------|---------------|-------------|
| michael@dansunauto.co.ke    | Dansunauto2026!   | super_admin |
...
PHX_HOST=dansunautoscloset.com \
