defmodule DansunautoWeb.OrderLive.Show do
  ...
  defp status_color(status) do
    case status do
      ...
      "cancelled" -> "bg-gray-100 text-gray-500 border-line"
      "failed" -> "bg-red-50 text-red-400 border-red-200"
      _ -> "bg-gray-100 text-gray-500 border-line"
    end
  end
    ...
    <!-- ── Left: items + totals ── -->
        <div class="space-y-6 lg:col-span-2">
          <div class="overflow-hidden rounded-3xl border border-line bg-white shadow-sm">
            ...
            <div class="border-t border-line bg-gray-50/60 px-6 py-5 space-y-2.5">
              ...
              <div class="flex justify-between border-t border-line pt-2.5 text-base font-bold text-ink">
                <span>Total</span>
    ...
    <!-- Status actions -->
          <div class="overflow-hidden rounded-3xl border border-line bg-white shadow-sm">
            <div class="border-b border-line px-5 py-4">
              <h2 class="font-display uppercase tracking-wide text-sm font-semibold text-ink">
                Order Status
              </h2>
            </div>
                      ...
                      <button
                        ...
                        class={[
                          ...
                          case next do
                            ...
                            "paid" -> "border-brand/30 bg-brand text-white hover:bg-[#a8001a]"
                            _ -> "border-brand/30 bg-brand text-white hover:bg-[#a8001a]"
                          end
                        ]}
                      >
                        <%= if next == "paid" do %>
                          ✓ Mark as Paid — deducts stock
                        <% else %>
                          Mark as {String.capitalize(next)} →
                        <% end %>
                      </button>
                    <% end %>
                  </div>
            ...
            <div class="px-5 py-4 space-y-3 text-sm">
              ...
              <div class="flex items-start justify-between gap-3">
                ...
                <a
                  ...
                  class="font-medium text-brand hover:underline text-right break-all"
                >
                  {@order.email}
                </a>
              </div>
