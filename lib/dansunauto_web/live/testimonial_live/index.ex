defmodule DansunautoWeb.TestimonialLive.Index do
  ...
  @impl true
  def handle_info({DansunautoWeb.TestimonialLive.FormComponent, {:saved, testimonial}}, socket) do
  ...
  def render(assigns) do
    ...
    >
      <.live_component
        module={DansunautoWeb.TestimonialLive.FormComponent}
