defmodule DansunautoWeb.ProductLive.Show do
  ...
  @impl true
  def handle_info({DansunautoWeb.ProductLive.FormComponent, {:saved, product}}, socket) do
    {:noreply,
     socket
     |> assign(:product, product)
     |> assign(:collection, load_collection(product.collection_id))}
  ...
  def render(assigns) do
    ...
    >
      <.live_component
        module={DansunautoWeb.ProductLive.FormComponent}
        id={@product.id}
        title="Edit Product"
        action={@live_action}
        product={@product}
        collections={Dansunauto.Collections.list_collections()}
