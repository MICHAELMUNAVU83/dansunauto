defmodule DansunautoWeb.CollectionLive.Show do
  ...
  @impl true
  def handle_info({DansunautoWeb.CollectionLive.FormComponent, {:saved, collection}}, socket) do
  ...
  def render(assigns) do
    ...
    >
      <.live_component
        module={DansunautoWeb.CollectionLive.FormComponent}
        id={@collection.id}
