defmodule DansunautoWeb.CollectionLive.FormComponent do
  use DansunautoWeb, :live_component

  alias Dansunauto.Collections
      ...
      >
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <label class="flex h-[42px] cursor-pointer items-center gap-3 rounded-lg border border-line bg-white px-3.5 transition hover:bg-gray-50">
              ...
              <input
                ...
                value="true"
                class="h-4 w-4 rounded border-gray-300 text-ink focus:ring-0 focus:ring-offset-0"
              />
