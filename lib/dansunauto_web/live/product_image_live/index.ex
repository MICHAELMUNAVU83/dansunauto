defmodule DansunautoWeb.ProductImageLive.Index do
  use DansunautoWeb, :live_view

  alias Dansunauto.ProductImages
  alias Dansunauto.ProductImages.ProductImage
  ...
  @impl true
  def handle_info({DansunautoWeb.ProductImageLive.FormComponent, {:saved, product_image}}, socket) do
