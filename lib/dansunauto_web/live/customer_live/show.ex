defmodule DansunautoWeb.CustomerLive.Show do
  use DansunautoWeb, :admin_live_view

  alias Dansunauto.Customers
  ...
  def render(assigns) do
    ...
    <!-- ── Hero banner ── -->
      <div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-brand to-[#8b0014] px-7 py-6 text-white shadow-md">
        ...
        <div class="flex items-center gap-4">
          ...
          <div class={[
            "flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full text-lg font-bold text-white ring-2 ring-white/30 shadow-md",
            avatar_color(@customer.email)
          ]}>
            {initials(@customer.name)}
          </div>
          <div>
            <p class="text-xs font-medium uppercase tracking-widest text-red-200">Customer</p>
            <h1 class="mt-0.5 font-display uppercase tracking-wide text-xl font-bold">
              {@customer.name}
            </h1>
    ...
    <!-- Stat strip -->
      <div class="grid grid-cols-3 gap-4">
        <div class="overflow-hidden rounded-3xl border border-brand/20 bg-brand/5 p-5">
          <p class="text-xs font-semibold uppercase tracking-widest text-brand/70">Total Spent</p>
          <p class="mt-2 font-display uppercase tracking-wide text-2xl font-bold text-brand">
            KES {fmt(@customer.total_spent)}
          </p>
        </div>
        <div class="overflow-hidden rounded-3xl border border-line bg-white p-5 shadow-sm">
          ...
          <p class="mt-2 font-display uppercase tracking-wide text-2xl font-bold text-ink">
    ...
    <!-- Order history -->
          <div class="overflow-hidden rounded-3xl border border-line bg-white shadow-sm">
            <div class="border-b border-line px-6 py-5">
              <h2 class="font-display uppercase tracking-wide text-base font-semibold text-ink">
                Order History
                <span class="ml-1.5 rounded-full bg-gray-100 px-2 py-0.5 text-xs font-bold text-gray-500">
                  {length(@orders)}
                </span>
              </h2>
            </div>
            ...
            <div class="px-5 py-4 space-y-3 text-sm">
              <div>
                ...
                <a
                  ...
                  class="font-medium text-brand hover:underline break-all"
                >
                  {@customer.email}
                </a>
              </div>
