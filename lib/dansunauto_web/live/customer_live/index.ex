defmodule DansunautoWeb.CustomerLive.Index do
  ...
  def render(assigns) do
      ...
      <div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-brand to-[#8b0014] px-7 py-6 text-white shadow-md">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h1 class="mt-0.5 font-display uppercase tracking-wide text-2xl font-bold">Customers</h1>
    ...
    <!-- Customer table -->
      <%= if @customers == [] do %>
        <div class="flex flex-col items-center justify-center rounded-3xl border border-line bg-white py-24 text-center shadow-sm">
                ...
                >
                  <td class="px-5 py-3.5">
                    <div class="flex items-center gap-3">
                      <div class={[
                        "flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full text-sm font-bold text-white shadow-sm",
                  ...
                  <td class="px-5 py-3.5">
                    <span class="inline-flex items-center gap-1 rounded-full bg-brand/10 px-2.5 py-1 text-xs font-semibold text-brand">
                      {customer.order_count} {if customer.order_count == 1,
                        do: "order",
                        else: "orders"}
                    </span>
                  </td>
