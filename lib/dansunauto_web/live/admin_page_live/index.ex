defmodule DansunautoWeb.AdminPageLive.Index do
  ...
  def handle_event("cancel", _params, socket) do
    {:noreply,
     socket |> assign(:editing_id, nil) |> assign(:form, nil) |> assign(:save_error, nil)}
  end
  ...
  def render(assigns) do
    ...
    <div>
      ...
      <div>
        ...
        <%= if @form do %>
          <% page = @form.data %>
          <div class="mb-8 overflow-hidden rounded-3xl border border-line bg-white shadow-sm">
            ...
            <.form for={@form} phx-change="validate" phx-submit="save" class="p-6 space-y-5">
              ...
              <div class="grid gap-5 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <div class="flex items-center rounded-xl border border-line bg-gray-50 px-4 py-2.5 text-sm text-gray-500">
              ...
              <div>
                ...
                <p class="mb-2 text-xs text-gray-400">
                  Supports simple formatting: <code class="rounded bg-gray-100 px-1">## Heading</code>, <code class="rounded bg-gray-100 px-1">### Sub-heading</code>, <code class="rounded bg-gray-100 px-1">**bold**</code>,
          ...
          <%= if @pages == [] do %>
            <div class="px-6 py-16 text-center">
              ...
              <p class="mt-3 text-sm font-medium text-gray-500">
                No pages yet. Run seeds to add the default pages.
              </p>
            </div>
          <% else %>
            <div class="divide-y divide-line">
              <%= for page <- @pages do %>
                <div class={"flex items-start gap-4 px-6 py-5 transition hover:bg-gray-50 #{if @editing_id == page.id, do: "bg-brand/3"}"}>
                  ...
                  <div class="min-w-0 flex-1">
                    ...
                    <p class="mt-0.5 truncate text-xs text-gray-400">
                      <%= if page.content && page.content != "" do %>
                        {String.slice(page.content, 0, 100)}{if String.length(page.content || "") >
                                                                  100,
                                                                do: "…"}
                      <% else %>
                  ...
                  <div class="flex flex-shrink-0 items-center gap-2">
                    ...
                    <a
                      href={"/info/#{page.slug}"}
                      target="_blank"
                      class="rounded-lg border border-line p-1.5 text-gray-400 transition hover:border-gray-400 hover:text-gray-700"
                    >
                      <svg
                        class="h-4 w-4"
                        fill="none"
