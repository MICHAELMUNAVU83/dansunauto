defmodule DansunautoWeb.HomeComponents do
  use Phoenix.Component
  use Gettext, backend: DansunautoWeb.Gettext

  alias Dansunauto.Shop.DummyData
    ...
    <!-- Color Options -->
              ...
              <div class="mt-1 flex items-center gap-2">
                <span class="text-base font-semibold text-red-500">
                  KES {DansunautoWeb.Format.price(product[:price] || 0)}
                </span>
                <%= if product[:original_price] do %>
                  <span class="text-sm text-gray-400 line-through">
                    KES {DansunautoWeb.Format.price(product[:original_price] || 0)}
                  </span>
                <% end %>
              </div>
            </a>
              ...
              <div class="mt-4 flex items-center gap-3 rounded-lg bg-gray-50 p-2.5">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-600">
                    KES {DansunautoWeb.Format.price(testimonial.product.price)}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul class="mt-6 space-y-4">
              ...
              <li>
                <a
                  href="https://instagram.com/dansunautos_closet_page"
                  target="_blank"
                  rel="noopener noreferrer"
                  class="flex items-center gap-3 text-gray-400 transition hover:text-white"
                >
                  ...
                  <span>@dansunautos_closet_page</span>
                </a>
              </li>
              <li>
                <a
                  href="https://tiktok.com/@dansunautos_closet_page"
                  target="_blank"
                  rel="noopener noreferrer"
                  class="flex items-center gap-3 text-gray-400 transition hover:text-white"
                >
          ...
          <div>
            ...
            <ul class="mt-6 space-y-3">
              <li>
                <a href="/info/services" class="text-gray-400 transition hover:text-white">
                  🛠️ Services
                </a>
              </li>
              <li>
                <a href="/info/spare-parts" class="text-gray-400 transition hover:text-white">
                  ⚙️ Spare Parts
                </a>
              </li>
              <li>
                <a href="/info/how-it-works" class="text-gray-400 transition hover:text-white">
                  📋 How It Works
                </a>
              </li>
              <li>
                <a href="/info/faq" class="text-gray-400 transition hover:text-white">
                  ❓ FAQ
                </a>
              </li>
              <li>
                <a
                  href="https://wa.me/254796770862?text=Hi%20Dansunauto%2C%20I%20want%20to%20track%20my%20order"
                  target="_blank"
                  rel="noopener noreferrer"
      ...
      <div class="border-t border-gray-800 py-6 px-4">
        <div class="mx-auto flex max-w-7xl flex-col items-center gap-2 sm:flex-row sm:justify-between">
          <p class="text-sm text-gray-500">
            &copy; {Date.utc_today().year} Dansunauto's Closet. All rights reserved.
          </p>
          <p class="text-sm text-gray-600">
            Designed by
