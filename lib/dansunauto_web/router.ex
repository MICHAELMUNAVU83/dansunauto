defmodule DansunautoWeb.Router do
  use DansunautoWeb, :router

  import DansunautoWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {DansunautoWeb.Layouts, :root}
  ...
  scope "/", DansunautoWeb do
    ...
    live_session :admin,
      on_mount: [{DansunautoWeb.UserAuth, :require_admin}] do
      scope "/admin" do
  ...
  # scope "/api", DansunautoWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:dansunauto, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: DansunautoWeb.Telemetry
  ...
  scope "/", DansunautoWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{DansunautoWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", DansunautoWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{DansunautoWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", DansunautoWeb do
    ...
    live_session :current_user,
      on_mount: [{DansunautoWeb.UserAuth, :mount_current_user}] do
