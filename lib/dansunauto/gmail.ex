                ...
                <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                  ...
                  <tr>
                    <td align="center" style="padding-bottom:20px;">
                      ...
                      <span style="color:rgba(255,255,255,0.2);">·</span>
                      <a href="#{Dansunauto.AppConfig.site_url()}" style="display:inline-block;margin:0 8px;color:rgba(255,255,255,0.5);font-size:12px;text-decoration:none;">Shop Online</a>
                    </td>
                  </tr>
                  <tr>
                    <td align="center">
