defmodule Dansunauto.OrderNotifier do
  ...
  def send_confirmation(%{email: email, name: name, reference: reference, items: items, total_amount: total} = order) do
    ...
    whatsapp_url = "https://wa.me/254796770862?text=Hi%20Dansunauto%2C%20my%20order%20ref%20is%20#{reference}"
    ...
    body = Gmail.branded_email(
      ...
      """,
      preview: "Your order #{reference} is confirmed — thanks for shopping with Dansunauto's Closet!",
