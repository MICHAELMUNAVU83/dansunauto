...
config :dansunauto, DansunautoWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: DansunautoWeb.ErrorHTML, json: DansunautoWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Dansunauto.PubSub,
...
config :dansunauto, Dansunauto.Mailer, adapter: Swoosh.Adapters.Local
